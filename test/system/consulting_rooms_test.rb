...
class ConsultingRoomsTest < ApplicationSystemTestCase
  ...
  test "creating a Consulting room" do
    ...
    fill_in "Codigo", with: @consulting_room.codigo
    fill_in "Nombre", with: @consulting_room.nombre
    fill_in "Tipo", with: @consulting_room.tipo
    fill_in "Ubicacion", with: @consulting_room.ubicacion
