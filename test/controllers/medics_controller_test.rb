...
class MedicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medic" do
    assert_difference('Medic.count') do
      post medics_url, params: { medic: { apellido: @medic.apellido, celular: @medic.celular, identificacion: @medic.identificacion, nombre: @medic.nombre, tipo: @medic.tipo } }
    end
  ...
  test "should update medic" do
    patch medic_url(@medic), params: { medic: { apellido: @medic.apellido, celular: @medic.celular, identificacion: @medic.identificacion, nombre: @medic.nombre, tipo: @medic.tipo } }
