...
class ConsultingRoomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consulting_room" do
    assert_difference('ConsultingRoom.count') do
      post consulting_rooms_url, params: { consulting_room: { codigo: @consulting_room.codigo, nombre: @consulting_room.nombre, tipo: @consulting_room.tipo, ubicacion: @consulting_room.ubicacion } }
    end
  ...
  test "should update consulting_room" do
    patch consulting_room_url(@consulting_room), params: { consulting_room: { codigo: @consulting_room.codigo, nombre: @consulting_room.nombre, tipo: @consulting_room.tipo, ubicacion: @consulting_room.ubicacion } }
